...
- **Platby (Paddle):** kód hotový, sandbox E2E ✅, doména `lexinova.fun` schválená Paddlom (2026-07-10) ✅ — **zostáva live konfigurácia** (checkout settings, webhook, env, E2E s reálnou kartou — viď checklist v `TODO.md`)
